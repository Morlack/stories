...
public class RetrieveTestData
{
	...
	public static List<JiraIssueDTO> getExportedTestResultFromResource(){
		JiraIssueDTO jiraIssueDTO = JiraIssueDTO.builder()
				.key("Gareth-2001")
				.description(
				"As a super office user\n" +
				"I would like to be informed about the alarms in my user\n" +
		...
		return Arrays.asList(jiraIssueDTO, jiraIssueDTO, jiraIssueDTO, jiraIssueDTO);
	}
